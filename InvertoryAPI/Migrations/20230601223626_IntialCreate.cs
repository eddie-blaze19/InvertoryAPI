        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CouponName = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Items_instock = table.Column<int>(type: "int", nullable: false),
                    Product_Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sales_Coupons_CouponsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Purchases_Suppliers_SuppliersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Purchases_SuppliersId",
                table: "Purchases",
                column: "SuppliersId");

            migrationBuilder.CreateIndex(
                name: "IX_Sales_CouponsId",
                table: "Sales",
                column: "CouponsId");
